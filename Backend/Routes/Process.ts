...
import { Process, FetchData,ProcessData,VendorsData,GetPrediction,InvestSuggestion} from "../Controllerse/UserController.js";
...
router.get('/Investment',InvestSuggestion)
